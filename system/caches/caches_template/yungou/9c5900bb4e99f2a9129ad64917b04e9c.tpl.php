	...
	<div class="submitted">
		<ul class="order">
			...
			<li class="end" id="shoplist<?php echo $shops['id']; ?>">
				...
				<span class="moneys"><?php echo $shops['money']; ?>云购币</span>
				<span class="money"><span class="color"><b><?php echo $shops['yunjiage']; ?>云购币</b></span></span>
				<span class="num">
			...
			<li class="ts">
				<p class="right">云购金额总计:￥<span id="moenyCount"  style="color: #22AAFF;"><?php echo $MoenyCount; ?></span></p>
			</li>
		</ul>
	</div>
	<h5>
		<a href="<?php echo WEB_PATH; ?>" id="but_on">返回继续云购</a>
