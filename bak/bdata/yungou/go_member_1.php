...
DoSetDbChar('utf8');
E_D("DROP TABLE IF EXISTS `go_member`;");
E_C("CREATE TABLE `go_member` (
...
E_D("replace into `go_member` values('1','111','111@qq.com','15889311715','96e79218965eb72c92a549dd5a330112',',127.0.0.1','photo/member.jpg','','1',NULL,'1.00','1','1','0','-1',NULL,'111111','1111111','0',NULL,'1470579545','','','0','0');");
